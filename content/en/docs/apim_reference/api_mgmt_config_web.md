...
* **Password history length**: Set the number of times a password must be changed before it can be reused. The default value is `10`. The value must be a number between 1 and 100 passwords saved.
