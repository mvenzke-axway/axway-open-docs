...
For example, `trustStore.jks`. This file is an optional truststore that contains the required IdP server certificates, and it is referenced in the `service-provider.xml` file.
