...
Both HTTP and HTTPS with self-signed certificate increase the risk of security vulnerabilities; therefore, they should not be used in production environments.  {{< /alert >}}
