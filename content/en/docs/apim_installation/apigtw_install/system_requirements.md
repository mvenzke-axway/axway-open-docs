...
API Gateway and API Manager support Apache Cassandra version 4.0.10 for internal data storage. For more details, see [Install an Apache Cassandra database](/docs/apim_installation/apigtw_install/cassandra_install).
